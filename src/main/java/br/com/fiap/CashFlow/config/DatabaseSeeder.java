...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Usuario usuario = new Usuario(null, null, "Mariana Santos", "mariana@gmail.com", "1234567", "707070", "000.000.000-00", new Date(), "00000000", "rua exemplo", "São Paulo", "123", "SP", 700.0f);
